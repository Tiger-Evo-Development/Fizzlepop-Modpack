...
set FORGE_URL="https://maven.minecraftforge.net/net/minecraftforge/forge/1.19.2-%FORGE_VERSION%/forge-1.19.2-%FORGE_VERSION%-installer.jar"
...
"%ATM9_JAVA%" -version 1>nul 2>nul || (
   echo Minecraft 1.19.2 requires Java 17 - Java not found
   pause
   exit /b 1
)
...
if not %jver% geq 17  (
    echo Minecraft 1.19.2 requires Java 17 - found Java %jver%
    pause
    exit /b 1
) 

:START
"%ATM9_JAVA%" @user_jvm_args.txt @libraries/net/minecraftforge/forge/1.19.2-%FORGE_VERSION%/win_args.txt nogui
